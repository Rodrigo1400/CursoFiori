		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zgcfioriajrpp",
									"targetURL": "#zgcfioriajrppzgcfioriajrpp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zgcfioriajrppzgcfioriajrpp-display": {
								"semanticObject": "zgcfioriajrppzgcfioriajrpp",
								"action": "display",
								"description": "zgcfioriajrpp",
								"title": "zgcfioriajrpp",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zgcfioriajrpp.zgcfioriajrpp",
									"url": sap.ui.require.toUrl("zgcfioriajrpp/zgcfioriajrpp")
								}
							}
						}
					}
