		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "zgcfiorirjapp",
									"targetURL": "#zgcfiorirjappzgcfiorirjapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zgcfiorirjappzgcfiorirjapp-display": {
								"semanticObject": "zgcfiorirjappzgcfiorirjapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zgcfiorirjapp.zgcfiorirjapp",
									"url": sap.ui.require.toUrl("zgcfiorirjapp/zgcfiorirjapp")
								}
							}
						}
					}
